...
#+BEGIN_SRC
core_1.rasterizer_1.o @ cycle 5241000 payload={x: 396, y: 189, W: 1.972412, S: 124.492, T: 57.031}
# ref: {x: 396, y: 189, W: 1.972427, S: 124.492, T: 57.031}
# same fragment enters both paths
# tiny W precision loss is already present
-> core_1.tmu_1.io_output @ cycle 5241001 payload={S': 63.469, T': 13.984, lod: 0, texel: 0x58}
# ref: {S': 63.492, T': 14.031, lod: 1, texel: 0x6B}
# FIRST DIVERGENCE
# perspective rounding / per-pixel LOD differs here
-> core_1.fbAccess.read @ cycle 5241002 payload={dst565: 0x4A29}
# ref: {dst565: 0x4A29}
# framebuffer read matches exactly
# cache theory ruled out here
-> core_1.colorCombine_1.o @ cycle 5241002 payload={src: 0x56C9, dst_blend: 0x4A29, out: 0x39E7}
# ref: {src: 0x5A8C, dst_blend: 0x49E7, out: 0x4A69}
# second divergence
# reference blend math effectively uses dither-subtracted destination color
-> core_1.writeColor.i_fromPipeline @ cycle 5241003 payload={final565: 0x39E7}
# ref: {final565: 0x4A69}
# visible symptom: RTL lands much darker than the reference
#+END_SRC
